  ...
  return (
    <div className="bg-[#F7F7F5] min-h-screen">
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-end">
            <div className="lg:col-span-2">
              ...
              <h1 className="font-display font-800 text-5xl lg:text-6xl text-white leading-tight mb-6">
                Security &<br />Trust
              </h1>
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                <div key={b.label} className="p-4 rounded-xl border border-white/8 bg-white/3">
                  <p className="font-mono font-700 text-lg text-[#2F6BFF]">{b.label}</p>
                  <p className="text-xs text-white/30 mt-1">{b.desc}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <div className="max-w-[1200px] mx-auto px-6 py-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {partners.map(p => (
              <div key={p.name} className="bg-white rounded-2xl border border-[#0A0B0D]/6 p-5 flex flex-col items-center text-center gap-3">
                <div className="w-12 h-12 rounded-xl bg-[#0A0B0D]/5 flex items-center justify-center font-display font-800 text-lg text-[#0A0B0D]">{p.logo}</div>
                <div>
        ...
        <div className="bg-[#0A0B0D] rounded-2xl p-8">
          <h3 className="font-display font-700 text-xl text-white mb-3">Responsible Disclosure</h3>
