  ...
  return (
    <div className="min-h-screen bg-[#F7F7F5] flex items-center justify-center px-6 relative overflow-hidden">
      <div className="absolute inset-0 flex items-center justify-center">
        <span className="font-display font-900 text-[20vw] text-black/3 select-none leading-none">404</span>
      </div>
      <div className="relative z-10 text-center max-w-md">
        ...
        <h1 className="font-display font-800 text-4xl text-[#0A0B0D] mb-4">Lost in the market</h1>
