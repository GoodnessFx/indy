  ...
  return (
    <div className="min-h-screen bg-[#F7F7F5] flex items-center justify-center px-6">
      <div className="text-center max-w-md">
        ...
        <h1 className="font-display font-800 text-3xl text-[#0A0B0D] mb-4">Scheduled maintenance</h1>
        ...
        <div className="glass rounded-2xl border border-black/8 px-6 py-4 mb-8">
          <p className="text-xs text-black/30 mb-2 font-mono">ESTIMATED RETURN</p>
          <p className="font-mono font-700 text-2xl text-[#0A0B0D]">Today at 06:00 UTC</p>
        </div>
        <div className="flex items-center gap-2 justify-center">
          <div className="w-2 h-2 rounded-full bg-[#F59E0B] dot-pulse" />
          <span className="text-xs text-black/30 font-mono">Maintenance in progress</span>
        </div>
      </div>
    </div>
  );
