  ...
  return (
    <div className="min-h-screen bg-[#0A0B0D]">
      ...
      <div className="relative min-h-[82vh] flex items-end overflow-hidden" key={active.id}>
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-[#0A0B0D] via-[#0A0B0D]/40 to-[#0A0B0D]/30" />
        ...
        <div className="relative max-w-[1440px] mx-auto px-6 lg:px-12 w-full pb-12 lg:pb-16 pt-40">
          ...
          {/* Spec strip */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-white/10 rounded-2xl overflow-hidden border border-white/10 max-w-3xl mb-4">
            {specs.map(s => (
              <div key={s.label} className="bg-[#0A0B0D]/80 backdrop-blur-md px-5 py-4">
      ...
      <div className="border-t border-white/5 bg-[#0A0B0D]">
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12 py-16 lg:py-24">
          <div className="grid lg:grid-cols-[1fr_1.2fr] gap-12 lg:gap-24 items-start">
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              {[
                ...
                <div key={card.title} className="rounded-2xl border border-white/8 bg-[#111318] p-6">
          ...
          <div className="mt-12 rounded-2xl border border-white/8 bg-[#111318] px-6 lg:px-8 py-6 flex flex-col md:flex-row md:items-center gap-4 md:gap-8">
            ...
            <div className="md:ml-auto flex items-center gap-2 shrink-0">
              ...
              <span className="text-xs text-white/40">Allocation window open</span>
            </div>
          </div>
        </div>
      </div>
