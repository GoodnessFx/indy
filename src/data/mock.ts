...
export const mockNFTs = [
  {
    id: 'nft-bored-ape',
    name: 'Bored Ape Yacht Club #7492',
    ...
    owner: 'Michael',
    profit: 150000,
    saleEnds: 'November 6, 2024 at 12:43 PM',
    traits: [
      { trait: 'Eyes', trait_type: 'Eyes', value: 'Sleepy / Closed' },
      { trait: 'Mouth', trait_type: 'Mouth', value: 'Gold Grill Teeth' },
      { trait: 'Hat', trait_type: 'Hat', value: 'Black Cap with Pin' },
      { trait: 'Fur', trait_type: 'Fur', value: 'Gold Skin' },
      { trait: 'Clothes', trait_type: 'Clothes', value: 'Suit with Tie' },
      { trait: 'Owner', trait_type: 'Owner', value: 'Michael' },
    ],
  },
  { id: 'nft-1', name: 'Mona Lisa, Restored Study', collection: 'Old Masters', price: 4.2, currency: 'ETH', usd: 14700, change: 12.4, image: 'art-tide', verified: true, rarity: 'Legendary', views: 42, traits: [{ trait: 'Period', value: '1503 to 1519' }, { trait: 'Medium', value: 'Oil on poplar' }, { trait: 'Edition', value: '1 of 10' }] },
  { id: 'nft-2', name: 'The Hoffmann Hare', collection: 'Wildlife Studies', price: 1.8, currency: 'ETH', usd: 6300, change: -3.2, image: 'art-ember', verified: true, rarity: 'Rare', views: 29, traits: [{ trait: 'Period', value: '1582' }, { trait: 'Medium', value: 'Watercolour' }, { trait: 'Edition', value: '1 of 50' }] },
