...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0A0B0D] border-t border-white/5">
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-3 mb-8">
              {[ExternalLink, ExternalLink, ExternalLink, ExternalLink].map((Icon, i) => (
                <a key={i} href="#" className="w-9 h-9 rounded-lg bg-white/5 flex items-center justify-center text-white/40 hover:text-white hover:bg-white/10 transition-colors">
                  <Icon size={15} />
                </a>
              ))}
            </div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-white/30">Available in 6 languages</span>
            </div>
          </div>

          {/* Product */}
          <div>
            <h4 className="font-display font-600 text-sm text-white mb-5">Product</h4>
            <ul className="space-y-3">
              {[
                ...
                <li key={item.to}>
                  <Link to={item.to} className="text-sm text-white/40 hover:text-white transition-colors">{item.label}</Link>
                </li>
              ))}
            </ul>
          </div>
          ...
          {/* Company */}
          <div>
            <h4 className="font-display font-600 text-sm text-white mb-5">Company</h4>
            <ul className="space-y-3">
              {[
          ...
          {/* Legal + Support */}
          <div>
            <h4 className="font-display font-600 text-sm text-white mb-5">Support & Legal</h4>
            <ul className="space-y-3">
              {[
        ...
        <div className="mt-16 pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex flex-col md:flex-row items-center gap-4">
            <p className="text-xs text-white/25">© 2026 IndySolutions Ltd. All rights reserved.</p>
            <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-6">
            <p className="text-xs text-white/20">Regulated by FCA · DFSA · SEC registered</p>
            {/* Hidden admin trigger */}
            <button
              onClick={handleDotClick}
              className="w-2 h-2 rounded-full bg-white/10 hover:bg-white/20 transition-colors"
              title=""
              aria-hidden="true"
            />
          </div>
        ...
        <p className="mt-6 text-[11px] text-white/15 leading-relaxed max-w-3xl">
